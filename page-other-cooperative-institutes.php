...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
		...
		<div id="container">
			<header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
				...
				<div class="bcg subSubHome">
						...
						<h2 class="page-title">NOAA Cooperative Institutes</h2>
						</div>
						</div>
					</div>
	<div class="wrapXL">
	...
	<div id="content">
		<div id="inner-content" class="wrapXL cf">
			<main id="main" class="m-all t-all d-all bottomMargin cf" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
			...
			<section class="d-1of3 t-1of3 m-all">
			<h3>Western</h3><hr>
				<?php if( have_rows('listWC') ): 
				while ( have_rows('listWC') ) : the_row();?>
				<a href="<?php the_sub_field('ci_link');?>">
				<div class="titleRow">
        			<p><?php the_sub_field('ci_name'); ?> - <?php the_sub_field('ci_full_title'); ?></p>
        		</div>
        		<div class="locationRow">
        		<i class="fa fa-long-arrow-right" aria-hidden="true"></i>
        		<?php the_sub_field('ci_location'); ?>
        		</div>
        		</a>
    		...
    		<section class="d-1of3 t-1of3 m-all">
			<h3>Central</h3><hr>
				<?php if( have_rows('listCENT') ): 
				while ( have_rows('listCENT') ) : the_row();?>
				<a href="<?php the_sub_field('ci_link');?>">
				<div class="titleRow">
        			<p><?php the_sub_field('ci_name'); ?> - <?php the_sub_field('ci_full_title'); ?></p>
        		</div>
    		...
    		<section class="d-1of3 t-1of3 m-all">
			<h3>Eastern</h3><hr>
				<?php if( have_rows('listEC') ): 
				while ( have_rows('listEC') ) : the_row();?>
				<a href="<?php the_sub_field('ci_link');?>">
				<div class="titleRow">
        			<p><?php the_sub_field('ci_name'); ?> - <?php the_sub_field('ci_full_title'); ?></p>
        		</div>
